...
class TestAccounts(unittest.TestCase):
	...
	def test_success_LogIn(self):
		result = self.acc.LogIn('grace', 'welcome')
	...
	def test_success_registration(self):
		result = self.acc.register('john', 'john@gmail.com', 'johnjohn', 'johnjohn')
		self.assertEqual(result, "Successfully signed up. You can now LogIn.")

	def test_rpt_username(self):
		result = self.acc.register('grace', 'grayce@gmail.com', 'kimotho', 'kimotho')
